...
static struct l3g4200d_gyr_platform_data *
l3g4200d_getdevtree_pdata(struct i2c_client *client,
					struct l3g4200d_gyr_platform_data **ppdata)
{
struct l3g4200d_gyr_platform_data *pdata =kmalloc(sizeof(struct l3g4200d_gyr_platform_data), GFP_KERNEL);
	if(pdata == NULL){
		dev_err(&client->dev,
					...
					const struct i2c_device_id *devid)
{
    ...
    if (client->dev.platform_data == NULL) {
		if(l3g4200d_getdevtree_pdata(client,&pdata) == NULL) {
